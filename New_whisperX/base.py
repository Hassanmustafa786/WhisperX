...
# model_large = whisperx.load_model("base", device, compute_type=compute_type, download_root=model_dir)
...
if audio_file:
    ...
    # Load large model
    model_large = whisperx.load_model("base", device, compute_type=compute_type)
